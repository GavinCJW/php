...
function Delete(value){
	$.post('/SystemInterface/delete',{id: value},function (result) {if(result) box('alert','确认删除','删除成功！',function(){window.location.reload();});},'json')
	.error(function() {box('alert','确认删除','删除失败！');});
}

function Show(value){
	$.post('/SystemInterface/show',{id: value},function (result) {if(result) $("#data_show").text(result);})
...
$(function(){
	...
	$("#btn_add").click(function(){
		if(!isJsonFormat($("#updata").val()) || !isJsonFormat($("#redata").val())){
			box('alert','确认增加','数据格式有误！');
				...
				$.post("/SystemInterface/insert",data,function (result) {console.log(result);if(result) box('alert','确认增加','增加成功！',function(){window.location.reload();});},'json')
	...
	$("#btn_delete").click(function(){
		...
		if (opts == "") {  
			...
			box('confirm','确认删除',"确定删除吗？",
				function(result){ 
					if(result) 
						$.post('/SystemInterface/delete',{id: idArray},function (result) {if(result) box('alert','确认删除','删除成功！',function(){window.location.reload();});},'json')
						.error(function() {box('alert','确认删除','删除失败！');});
			}); 
		}  
	});
	...
	$("#btn_edit").click(function(){
		...
		console.log(data);
		$.post("/SystemInterface/edit",data,function (result) {if(result) box('alert','确认修改','修改成功！',function(){window.location.reload();});},'json')
